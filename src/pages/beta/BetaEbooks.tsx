import { allEbooks as ebooks } from "@/data/content";
import { Download, BookText } from "lucide-react";
import { useStudyMode } from "@/hooks/useStudyMode";
import "@/styles/material3.css";

// Study-related categories for filtering
              ...
              {filteredEbooks.map((ebook, index) => (
                ...
                >
                  <div className="aspect-[4/3] relative overflow-hidden">
                    <img
                      src={typeof ebook.image === 'string' ? ebook.image : ebook.image}
                      alt={ebook.title}
                    ...
                    />
                    <div 
                      className="absolute top-3 left-3 md3-chip"
                      style={{ 
