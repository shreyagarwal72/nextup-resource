    ...
    <>
      ...
      {createPortal(
        <>
          ...
          {/* Panel */}
          <div
            className={`fixed top-0 right-0 bottom-0 z-[9999] w-full max-w-sm transition-transform duration-500 ease-[cubic-bezier(0.05,0.7,0.1,1)] pointer-events-auto ${
              isOpen ? "translate-x-0" : "translate-x-full"
            }`}
          >
            <div className="h-full bg-background/95 backdrop-blur-xl flex flex-col border-l border-border/30">
              {/* Header */}
