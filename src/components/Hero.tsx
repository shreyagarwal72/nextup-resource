...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      {/* iOS-style animated liquid blobs */}
      <div className="liquid-blob w-[500px] h-[500px] bg-primary/25 top-10 -left-60 animate-breathe" style={{ animationDuration: "18s" }} />
      <div className="liquid-blob w-[400px] h-[400px] bg-purple-500/20 bottom-10 -right-52" style={{ animationDelay: "-4s", animationDuration: "22s" }} />
      <div className="liquid-blob w-[300px] h-[300px] bg-pink-400/15 top-1/2 left-1/4" style={{ animationDelay: "-8s", animationDuration: "20s" }} />
      <div className="liquid-blob w-[250px] h-[250px] bg-cyan-400/15 top-1/4 right-1/4" style={{ animationDelay: "-12s", animationDuration: "24s" }} />
